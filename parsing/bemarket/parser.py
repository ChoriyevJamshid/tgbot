...
def filter_list(items: list) -> list:
    ...
    removing_items = [
        'black', 'blue', 'silver', 'twilight', 'phantom', 'white', 'midnight', 'metallic', 'pacific',
        'cosmic', 'green', 'cream', 'orange', 'pink', 'cyan', 'lake', 'mirror', 'titanium', 'graphite',
        'emerald'
    ]
    ...
    if "(sm-a135)" in result:
        result.remove("(sm-a135)")
    if "" in result:
        result.remove("")
